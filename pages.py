def PrintError(Adress,Content):
	...
	return '<body style="margin:0px;padding:0px;background-color:' + ErrorBackground + ';"><img src="' + Adress + ErrorImage + '" style="height:600px;display: block;margin-left: auto;margin-right: auto"></src>';
